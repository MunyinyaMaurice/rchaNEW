...
Route::group(['middleware' => 'api', 'prefix' => 'auth'], function ($router) {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::PUT('/updateImage/{image_id}', [imagesController::class, 'updateImage']);
        Route::delete('/deleteImage/{image_id}', [imagesController::class, 'deleteImage']);
        Route::get('/getImageById/{image_id}', [imagesController::class, 'getImageById']);
